...
const cellar = (cmd, argTokens, message) => {
  ...
  if (cmdToken === 'suz') {
    ...
    message.reply(
      'Did you mean, ```Marmalade Milktea of the House Fox, First of Her Name, the Unburnt, Queen of the Pantry and of the First Ragnarokers, Archbishop of the Great land of Juno, Breaker of Lightning Chains, and Mother of Dragonfruits```'
    );
  }
};
